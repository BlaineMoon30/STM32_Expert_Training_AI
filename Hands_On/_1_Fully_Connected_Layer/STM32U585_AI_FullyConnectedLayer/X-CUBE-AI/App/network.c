...
#define AI_NETWORK_MODEL_SIGNATURE     "0xfda09e861780579d84a3f9fb5560c2be"
...
#define AI_TOOLS_DATE_TIME   "2024-11-04T20:43:11+0900"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 4, 10, 1, 1), AI_STRIDE_INIT(4, 4, 16, 160, 160),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 10, 8, 1, 1), AI_STRIDE_INIT(4, 4, 40, 320, 320),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 660, 1, 1),
    660, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &dense_dense_layer, 0x60cde41e, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 160);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 160);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 200);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 200);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 520);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 520);
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 552);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 552);
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 648);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 648);
    return true;
  }
