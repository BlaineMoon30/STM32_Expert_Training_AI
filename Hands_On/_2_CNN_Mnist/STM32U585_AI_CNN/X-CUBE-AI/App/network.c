...
#define AI_NETWORK_MODEL_SIGNATURE     "d287eebe9457dcf3ee67376f4227479c"
...
#define AI_TOOLS_DATE_TIME   "Mon Aug 21 00:23:52 2023"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 11, 11), AI_STRIDE_INIT(4, 4, 4, 256, 2816),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    139304, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 89664, 1, 1),
    89664, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    conv2d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    
    conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    
    max_pooling2d_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    max_pooling2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    
    conv2d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 24768);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 24768);
    
    conv2d_1_output_array.data = AI_PTR(g_network_activations_map[0] + 55744);
    conv2d_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 55744);
    
    max_pooling2d_1_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    max_pooling2d_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 6400);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6400);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 0);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 256);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 256);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 64256);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 64256);
    
    conv2d_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 64296);
    conv2d_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 64296);
    
    conv2d_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 65448);
    conv2d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 65448);
    
    conv2d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 65576);
    conv2d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 65576);
