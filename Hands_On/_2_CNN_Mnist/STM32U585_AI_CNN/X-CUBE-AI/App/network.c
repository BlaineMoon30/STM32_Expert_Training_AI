...
#define AI_NETWORK_MODEL_SIGNATURE     "0x429a372882fd5fb578e5f43ff2695953"
...
#define AI_TOOLS_DATE_TIME   "2024-11-04T20:51:43+0900"
...
/* Array#14 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_1_conv2d_scratch1_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Tensor #14 */
AI_TENSOR_OBJ_DECLARE(
  conv2d_1_conv2d_scratch1, AI_STATIC,
  14, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 11, 2), AI_STRIDE_INIT(4, 4, 4, 256, 2816),
  1, &conv2d_1_conv2d_scratch1_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &conv2d_1_conv2d_scratch0, &conv2d_1_conv2d_scratch1)
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 139304, 1, 1),
    139304, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &conv2d_conv2d_layer, 0xf40021ef, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    conv2d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    conv2d_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 3172);
    conv2d_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 3172);
    conv2d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 9828);
    conv2d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 9828);
    conv2d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv2d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    conv2d_1_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 1152);
    conv2d_1_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 1152);
    conv2d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 8548);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8548);
    ...
    dense_output_array.data = AI_PTR(g_network_activations_map[0] + 40);
    dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 40);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 1152);
    conv2d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1152);
    conv2d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 1280);
    conv2d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1280);
    conv2d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 75008);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 75008);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 75264);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 75264);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 139264);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 139264);
    return true;
  }
