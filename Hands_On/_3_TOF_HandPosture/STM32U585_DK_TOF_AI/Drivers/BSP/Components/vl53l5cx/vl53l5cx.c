...
int32_t VL53L5CX_ConfigProfile(VL53L5CX_Object_t *pObj, VL53L5CX_ProfileConfig_t *pConfig)
{
  ...
  else if (vl53l5cx_set_target_order(&pObj->Dev, 1 /* VL53LMZ_TARGET_ORDER_CLOSEST */) != VL53L5CX_STATUS_OK)
  {
    ret = VL53L5CX_ERROR;
  }
  else if (vl53l5cx_set_sharpener_percent(&pObj->Dev, 5) != VL53L5CX_STATUS_OK)
  {
    ret = VL53L5CX_ERROR;
  }
  else
