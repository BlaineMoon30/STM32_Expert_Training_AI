...
#define AI_NETWORK_MODEL_SIGNATURE     "e287d85db94a1ef90ae42cda488f8a73"
...
#define AI_TOOLS_DATE_TIME   "Thu Aug  3 14:57:18 2023"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 2, 3, 3, 8), AI_STRIDE_INIT(4, 4, 8, 24, 72),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 640);
    conv2d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 640);
