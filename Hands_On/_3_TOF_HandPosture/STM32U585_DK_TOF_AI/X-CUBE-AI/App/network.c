...
#define AI_NETWORK_MODEL_SIGNATURE     "0x95ddcef32eccad24d67a9ac537945220"
...
#define AI_TOOLS_DATE_TIME   "2024-11-04T20:58:19+0900"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 712);
    conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 712);
